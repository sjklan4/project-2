...
@section('passwordcontents')
    <div class="col-md-8 offset-lg-1 pb-5 mb-lg-2 mb-lg-4 pt-md-5 mt-n3 mt-md-0">
        <div class="ps-md-3 ps-lg-0 mt-md-2 pt-md-4 pb-md-2">
            <h1 class="h2 pt-xl-1 pb-3">비밀번호 변경</h1>
            <!-- Password -->
            ...
            <form class="needs-validation pb-3 pb-lg-4" action="{{ route('user.userpseditpost') }}" method="post" id="pwForm">
                ...
                <div class="row">
                    <div class="col-sm-6 mb-4">
                        <label for="bpassword" class="form-label fs-base">현재 비밀번호</label>
                ...
                <div class="row pb-2">
                    <div class="col-sm-6 mb-4">
                        <label for="newpassword" class="form-label fs-base">새 비밀번호</label>
                        <div class="password-toggle">
                    ...
                    <div class="col-sm-6 mb-4">
                        <label for="newpasswordchk" class="form-label fs-base">새 비밀번호확인</label>
                        <div class="password-toggle">
                ...
                <div class="d-flex mb-3">
                    ...
                    <button type = "submit" id="passwordchg" class="btn greenBtn">변경</button>
                </div>
            </form>
