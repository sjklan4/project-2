                                                ...
                                                <tbody>                                          
                                                    @forelse($data['dietFood']['dietBrf'] as $val)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form action="{{route('home.delete', ['df_id' => $val->df_id])}}" method="post" style="display:inline-block" id="delintakeform">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <input type="hidden" value="{{$val->df_id}}" name="date" id="deldintakeid">
                                                                    <input type="hidden" value="{{$data['date'] ?? $data['today']}}" name="date" id="deldate">
                                                                    <button type="button" class="delBtn" onclick="delintake()">
